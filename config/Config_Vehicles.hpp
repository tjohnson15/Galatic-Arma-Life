    ...
    */
    ...
    class cop_car {
        ...
        vehicles[] = {
            { "3AS_Barc", "" },
            { "3AS_BarcSideCar", "" },
            { "JMSLLTE_B_veh_AA5_reb_F", "call life_coplevel >= 2" }
        };
    };
    ...
    class cop_air {
        ...
        vehicles[] = {
            { "3AS_Patrol_LAAT_Police", "" },
            { "JMSLLTE_UwingHeli_veh_NRearly_F", "" },
            { "JMSLLTE_Xwing_NRearly_veh_F", "call life_coplevel >= 4" },
            { "JMSLLTE_YwingS3_NRearly_veh_F", "call life_coplevel >= 4" },
        };
    };
...
class LifeCfgVehicles {
    ...
    */
    ...
    class JMSLLTE_UwingHeli_veh_NRearly_F {
        vItemSpace = 150;
        conditions = "";
        price = 35000;
        textures[] = {};
    ...
    class JMSLLTE_Xwing_NRearly_veh_F {
        vItemSpace = 150;
        conditions = "";
        price = 45000;
        textures[] = {};
    ...
    class JMSLLTE_YwingS3_NRearly_veh_F {
        vItemSpace = 150;
        conditions = "";
        price = 85000;
        textures[] = {};
